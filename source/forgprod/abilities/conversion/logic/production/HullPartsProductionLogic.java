...
public class HullPartsProductionLogic extends ProductionLogic {
    ...
    public ArrayList<String> getRequired() {
        ArrayList<String> out = super.getRequired();
        if (getTertiaryInputType() != null && !getTertiaryInputType().equals("")){
            out.add(getTertiaryInputType());
        }
        if (getQuaternaryInputType() != null && !getQuaternaryInputType().equals("")){
            out.add(getQuaternaryInputType());
        }
        return out;
    }
    ...
    protected float getAvailableTertiaryInputs(CampaignFleetAPI fleet) {
        return Forgeprod_DefaultCargo.active.getCommodityAmount(this.productionType,tertiaryInputType,fleet.getCargo());//fleet.getCargo().getCommodityQuantity(tertiaryInputType);
    }

    protected float getAvailableQuaternaryInputs(CampaignFleetAPI fleet) {
        return Forgeprod_DefaultCargo.active.getCommodityAmount(this.productionType,quaternaryInputType,fleet.getCargo());//fleet.getCargo().getCommodityQuantity(quaternaryInputType);
    }
    ...
    protected void commenceProduction(CampaignFleetAPI fleet) {
        ...
        Forgeprod_DefaultCargo.active.removeCommodity(this.productionType,primaryInputType,dailyPrimaryInputsSpent,cargo);//cargo.removeCommodity(primaryInputType, dailyPrimaryInputsSpent);
        Forgeprod_DefaultCargo.active.removeCommodity(this.productionType,secondaryInputType,dailySecondaryInputsSpent,cargo);//cargo.removeCommodity(secondaryInputType, dailySecondaryInputsSpent);
        Forgeprod_DefaultCargo.active.removeCommodity(this.productionType,tertiaryInputType,dailyTertiaryInputsSpent,cargo);//cargo.removeCommodity(tertiaryInputType, dailyTertiaryInputsSpent);
        Forgeprod_DefaultCargo.active.removeCommodity(this.productionType,quaternaryInputType,dailyQuaternaryInputsSpent,cargo);//cargo.removeCommodity(quaternaryInputType, dailyQuaternaryInputsSpent);
        FleetwideModuleManager manager = FleetwideModuleManager.getInstance();
